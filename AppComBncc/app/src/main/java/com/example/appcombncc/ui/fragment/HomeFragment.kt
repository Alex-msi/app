...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        eiBt.setOnClickListener { navigateToSerie() }
        efBt.setOnClickListener { navigateToSerie() }
        emBt.setOnClickListener { navigateToSerie() }
    }
    private fun navigateToSerie() {
        val bundle = Bundle().apply { putString("etapaSelecionada", "") }
