...
class ObjetoResumoAdapter : RecyclerView.Adapter<ObjetoResumoAdapter.ObjetoResumoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ObjetoResumoViewHolder {
        ...
        return ObjetoResumoViewHolder(view)
    }
    ...
    class ObjetoResumoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
