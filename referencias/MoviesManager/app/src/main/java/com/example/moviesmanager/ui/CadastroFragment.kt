...
import com.example.moviesmanager.databinding.FragmentCadastroBinding
import com.example.moviesmanager.domain.Movies
import com.example.moviesmanager.viewmodel.CadastroState
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                ...
                return when (menuItem.itemId) {
                    R.id.action_salvarTitle -> {
                        ...
                        val year = binding.commonLayout.editTextYear.text.toString().toInt()
                        val studio = binding.commonLayout.editTextStudio.text.toString()
                        val duration = binding.commonLayout.editTextDuration.text.toString().toInt()
                        val watched = binding.commonLayout.CheckBoxWatched.isChecked
                        val rating = binding.commonLayout.editTextRating.text.toString().toFloatOrNull()?: 0.0f
                        val genre = binding.commonLayout.spinnerGenre.selectedItem.toString()
